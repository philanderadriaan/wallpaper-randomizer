...
public abstract class AbstractFilter implements Filter {
	...
	/**
	 * Applies a "weighting" to each pixel, where its new value is produced by doing
	 * a weighted average of the 3x3 grid of pixels around it. For example, A
	 * Gaussian blur/softening effect can be achieved by applying the following
	 ...
	 * @param the_weights The weights matrix. This must be a non-null 3x3 matrix or
	 *                    an IllegalArgumentException is thrown.
	 * @exception IllegalArgumentException if the weights are invalid.
	 */

	protected void weight(final PixelImage the_image, final int[][] the_weights) throws IllegalArgumentException {
	...
	protected void weight(final PixelImage the_image, final int[][] the_weights, final int the_scale)
	...
	/**
	 * Checks to see if the specified weights matrix is valid (that is, is non-null
	 * and a 3x3 grid).
	 * 
	...
	private void checkWeights(final int[][] the_weights) throws IllegalArgumentException {
		if (the_weights == null || the_weights.length != Pixel.CHANNELS || the_weights[0] == null
				|| the_weights[0].length != Pixel.CHANNELS || the_weights[1] == null
				|| the_weights[1].length != Pixel.CHANNELS || the_weights[2] == null
				|| the_weights[2].length != Pixel.CHANNELS) {
	...
	protected void swap(final Pixel[][] the_data, final int row_1, final int col_1, final int row_2, final int col_2) {
